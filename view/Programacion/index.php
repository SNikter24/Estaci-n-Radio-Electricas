...
$items = $baseDatos->conectar()->query('SELECT * FROM programa')->fetchAll(PDO::FETCH_ASSOC);
$subitems = $baseDatos->conectar()->query('SELECT * FROM subprograma')->fetchAll(PDO::FETCH_ASSOC);
?>
