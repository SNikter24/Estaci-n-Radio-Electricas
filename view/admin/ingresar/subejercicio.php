...
<div class="container col-sm-12">
    ...
    <html>
    <head>
    <title>Registro de Subitems</title>
    </head>
    <body>
    <h2>Registrar Subitem</h2>

    <form method="post" action="<?php echo constant('URL'); ?>Ingresar/registrarSubejercicio">
        ...
        <input type="submit" value="Registrar Subitem">
    </form>
</body>
</html>
