        ...
        <div class="row justify-content-center mb-3">
            <div class="overflow-y-scroll" style="max-width: 80%; max-height: 576px;">
                ...
                <form class="d-flex mb-3" role="Buscar" method="POST"
                    action="<?php echo constant('URL'); ?>Consultar/palabraClaveProveedor">
                ...
                if (empty($this->proveedores)) { ?>
                    ...
                    foreach ($this->proveedores as $fila) {
                        ...
                        <div class="col-sm-12 mb-3">
                            <div class="card text-bg-light">
                                <div class="card-body">
                                    <h5 class="card-title">
                                        <?php echo $proveedor->nombreEmpresa ?>
                                    </h5>
                                    <h6 class="card-subtitle mb-2 text-body-secondary">
                                        Nit:
                                        <?php echo $proveedor->nit ?>
                                    </h6>
                                    <p class="card-text">
                                        Correo:
                                        <?php echo $proveedor->correoEmpresa ?>
                                        <br>
                                        Contacto:
                                        <?php echo $proveedor->contacto ?>
                                    </p>
                                    <a href="<?php echo constant('URL') . 'Consultar/verProveedor/' . $proveedor->nit ?>"
                                    ...
                                    <a href="<?php echo constant('URL') . 'Consultar/eliminarProveedor/' . $proveedor->nit ?>"
